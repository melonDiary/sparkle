...
export function registerWindowIpc(deps: WindowIpcDeps): void {
  ...
  r('importThemes', (_e, file) => w(importThemes)(file))
  ...
  r('alert', (_e, msg) => { void showNotification({ title: 'Sparkle', body: msg, variant: 'danger' }) })
  ...
  r('getFilePath', (_e, ext, title, filterName) => getFilePath(ext, title, filterName))
